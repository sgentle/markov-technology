...
(function() {
  var $, addGroup, buffercache, context, defs, groupPulser, groups, labelGroup, linkGroup, makeNode, makePulser, massiveLagCallbacks, maybeFetch, nodeGroup, nodeProto, nodes, onMassiveLag, play, pulser, shadeGroup, svg, svgEl, svgText, watchFrameDrop;
  ...
  fetch('data.json').then(function(result) {
    ...
    for (k in ref1) {
      v = ref1[k];
      nodes[k] = makeNode("media/" + k + ".mp3", v);
    }
    ref2 = data.nodes;
    for (k in ref2) {
      v = ref2[k];
